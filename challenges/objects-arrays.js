...
// sort() is technically an array method but I'm not sure how else I would do this...
universities.sort();
...
zooAnimals.filter((e) => {
  if(e.population < 5) {
    largerPopulation.push(e.animal_name);
  }
});
...
const total = zooAnimals.reduce(function(accumulator, currentValue) {
  return accumulator + currentValue.population;
}, 0);
console.log(populationTotal + total);
